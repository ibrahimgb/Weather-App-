...
const loadWeather = (event) => {
    const sevedLocation = getHomeLocation();
    if (!sevedLocation &&  !event) return getGeoWeather();
    if (!sevedLocation && event.type === "click") {
        displayError("No Location Saved.","Sorry. Please save your home location first")
    }else if(sevedLocation && !event){
        displayHomeLocationWeather(sevedLocation);
    }else{
...
const submitNewLocation = async (event) => {
    ...
    const locationIcon = document.getElementById("searchIcon");
